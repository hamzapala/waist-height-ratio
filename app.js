...
// const waistMm = document.querySelector(".waistMm");
// const waistCm = document.querySelector(".waistCm");
// const waistM = document.querySelector(".waistM");
// const waistIn = document.querySelector(".waistIn");
// const waistFt = document.querySelector(".waistFt");
// const waistYd = document.querySelector(".waistYd");
...
// const heightYd = document.querySelector(".heightYd");
